...
This is the code designed to run a MAARU (Multichannel Autonomous Acoustic Recording Unit). Full details on applications and hardware setup [here](BeckyHeath.github.io/MAARU](https://beckyheath.github.io/MAARU/))
